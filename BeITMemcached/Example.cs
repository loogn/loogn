...
namespace BeIT.MemCached {
	...
	class Example {
		public static void Main(string[] args) {
            ...
            //MemcachedClient.Setup("MyCache", new string[] { "116.255.230.148:11211" });
            ...
            MemcachedClient cache = MemcachedClient.GetInstance("memcached");
            ...
            p.ID = 23;
            p.Name = "s股份有限公司";
            var flag= cache.Set("pp", p);
            Console.WriteLine(flag);


            var val = cache.Get("pp") as Person;
            if (val != null)
            {
            ...
            foreach (KeyValuePair<string, Dictionary<string, string>> host in cache.Stats())
            {
			...
			//Use custom hash
			cache.Set("secondstring", "sdfdddddddddddddddddddddddddf", 4711);
